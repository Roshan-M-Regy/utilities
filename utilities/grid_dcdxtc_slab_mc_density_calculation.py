...
def get_density(choices,user_bins, user_bin_edges,noofframes,univ,indexlist,indexname):
...
# Get density for groups
get_density(choices,user_bins,user_bin_edges,noofframes,univ,indexlist,indexname)
